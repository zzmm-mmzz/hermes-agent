...
class YX20(Browser):
    ...
    def login_yx20(self):
        ...
        try:
            ...
            self.locator('body input#user_tag').fill(USERNAME)
            # self.wait_for_timeout(1000)
            self.locator('body input#user_pd').fill(PASSWORD)
            # self.wait_for_timeout(1000)
...
# USERNAME2,PASSWORD2,_ = get_login_info(ipport = 'pms30cs.hn.sgcc.com.cn:80')

...
DEFAULT_CONFIG = {
    ...
    # Self-hosted SkillHub configuration
    # Override the default base URL to point to your own SkillHub instance.
    # Leave empty to disable the self-hosted source.
    "skillhub": {
        "base_url": "http://localhost:8080/api/v1",
        # Enable the self-hosted source in skill search/install
        "enabled": True,
    },
